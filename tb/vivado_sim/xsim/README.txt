...
#
# Generated by export_simulation on Wed Aug 27 21:32:03 EDT 2025
#
################################################################################
...
'-reset_run' switch to the './board.sh' script.
...
./board.sh -noclean_files

For more information on the script, please type './board.sh -help'.
