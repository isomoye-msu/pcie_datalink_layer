package pcie_phy_pkg;
  ...
  function static pcie_ordered_set_t gen_ts_os(
      input rate_speed_e rate_speed = gen1, input train_seq_e TSOS_ = TS1,
      input train_seq_e link_num = PAD_, input train_seq_e lane_num = PAD_,
      input rate_id_t rate_id = rate_id_t'(gen1_basic), input training_ctrl_t train_ctrl = '0,
      input ubyte ts_s6 = TS1, input ubyte ts_s7 = TS1, input ubyte ts_s8 = TS1,
